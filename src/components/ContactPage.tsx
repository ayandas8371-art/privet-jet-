      ...
      {isOpen && (
        ...
        >
          ...
          <div style={{ position: 'relative', height: '60vh', minHeight: '500px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', paddingBottom: '80px', overflow: 'hidden' }}>
            <video 
              src="/media/video/fling_jet_cinematic_2.mp4" 
              autoPlay 
              loop 
              muted 
              playsInline
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 24px 80px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '80px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
              ...
              <div style={{ width: '100%', height: '240px', borderRadius: '8px', overflow: 'hidden', position: 'relative', boxShadow: '0 8px 32px rgba(0,0,0,0.5)' }}>
                <img src="/media/Black_Plane_4.jpeg" alt="Luxury Jet" style={{ width: '100%', height: '100%', objectFit: 'cover', transition: 'transform 0.5s', cursor: 'pointer' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'} />
              ...
              <div style={{ width: '100%', height: '160px', borderRadius: '8px', overflow: 'hidden', position: 'relative', boxShadow: '0 8px 32px rgba(0,0,0,0.1)' }}>
                <img src="/media/main_hero_image.jpg" alt="Aviation Lifestyle" style={{ width: '100%', height: '100%', objectFit: 'cover', transition: 'transform 0.5s', cursor: 'pointer' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'} />
